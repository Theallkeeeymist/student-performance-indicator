...
class DataTransformation:
    ...
    def get_data_transformer_obj(self):
        ...
        try:
            ...
            logging.info(f"Numerical column: {numerical_columns} scaling completed")
    ...
    def initiate_data_transformation(self, train_path, test_path):
        try:
            ...
            logging.info("Test and Train data readed successfully.")
            ...
            train_arr=np.c_[ #np.c_ is a SHORTHAND for concatenate
            ...
            save_object(file_path=self.data_transformation_config.preprocessor_obj_filepath, obj=preprocessor)
